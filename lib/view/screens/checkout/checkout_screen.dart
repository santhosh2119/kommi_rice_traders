...
class CheckoutScreen extends StatefulWidget {
  ...
  CheckoutScreen({@required this.amount, @required this.orderType, @required this.discount});
                          ...
                          onPressed: () {
                            if (widget.orderType != 'self_pickup' && order.addressIndex == -1) {
                              ...
                              order.placeOrder(PlaceOrderBody(
                                cart: carts, orderType: widget.orderType, couponCode: '', orderNote: '', branchId: _branches[order.branchIndex].id,
