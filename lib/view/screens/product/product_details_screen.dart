...
class ProductDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Provider.of<ProductProvider>(context, listen: false).getProductDetails(context, product, cart);
                      ...
                      child: SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ProductTitleView(product: productProvider.product, stock: _stock, amount: PriceConverter.convertPrice(context, priceWithQuantity),
