                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                      ...
                                      onTap: () {
                                        Navigator.of(context).pushNamed(
                                          RouteHelper.getCategoryProductsRoute(
                                            ...
                                            categoryProvider.categoryList[categoryProvider.categorySelectedIndex].name,
                                          ),
                                  ...
                                  return ListTile(
                                    onTap: () {
                                      Navigator.of(context).pushNamed(
                                        RouteHelper.getCategoryProductsRoute(categoryProvider.subCategoryList[index-1].id, categoryProvider.subCategoryList[index-1].name),
                                      );
                                    },
