                              ...
                              child: Column(
                                ...
                                _isSelfPickupActive ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  ...
                                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                    ...
                                    Text(PriceConverter.convertPrice(context, (_itemPrice-_discount) ), style: poppinsRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                  ]),
                                  SizedBox(height: 10),
                                  ...
                                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                    Text(getTranslated('subtotal1', context), style: poppinsMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
