  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Stack(children: [
        ...
        Dismissible(
          key: Key(cart.variation != null ? cart.variation.type : cart.id.toString()),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        PriceConverter.convertPrice(context, (cart.discountedPrice*cart.quantity)),
                  ...
                  SizedBox(height: 5),
                  Row(children: [
                    Expanded(child: Text('${cart.variation.type}', style: poppinsRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL))),
                    InkWell(
                      onTap: () {
                        if (cart.quantity > 1) {
